...
entry(
    index = 1,
    label = "Root",
    kinetics = ArrheniusBM(A=(4.1139e+21,'m^3/(mol*s)'), n=-4.96127, w0=(542929,'J/mol'), E0=(196526,'J/mol'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.4651453113246855, var=30.08634280140156, Tref=1000.0, N=7, data_mean=0.0, correlation='Root',), comment="""BM rule fitted to 7 training reactions at node Root
    Total Standard Deviation in ln(k): 12.164882984885404"""),
    rank = 11,
...
entry(
    ...
    kinetics = ArrheniusBM(A=(5.1199e+06,'m^3/(mol*s)'), n=-1.00647, w0=(553500,'J/mol'), E0=(152881,'J/mol'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-1.1301607498976984, var=34.25827723850932, Tref=1000.0, N=3, data_mean=0.0, correlation='Root_Ext-1CbCbf-R',), comment="""BM rule fitted to 3 training reactions at node Root_Ext-1CbCbf-R
    Total Standard Deviation in ln(k): 14.573428722103277"""),
    rank = 11,
